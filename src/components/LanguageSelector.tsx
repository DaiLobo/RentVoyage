    ...
    <Popover>
      ...
      <PopoverContent className="w-42 p-2 flex flex-col items-center">
        <button
          ...
          className="rounded-full w-full flex items-center justify-center bg-white gap-2 bg-transparent hover:bg-accent hover:text-accent-foreground"
        >
          <Image
            src="/assets/pt-br-lang.png"
            alt="Português"
            width={26}
            height={26}
          />
        ...
        <button
          ...
          className="rounded-full w-full flex items-center justify-center bg-white gap-2 bg-transparent hover:bg-accent hover:text-accent-foreground mt-2 "
        >
          <Image
            src="/assets/eng-lang.png"
            alt="English"
            width={26}
            height={26}
          />
