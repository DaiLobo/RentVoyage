  ...
  return (
    <>
      <div className="grid grid-rows-3 grid-cols-1 gap-2 w-full max-w-xl">
        ...
        <FormInput required type="text" name="address" label={t("address.name")} placeholder={t("address.placeholder")} />
        ...
        <div className="grid grid-cols-2 gap-2">
          <FormInput required type="number" name="price" label={t("price.name")} placeholder={t("price.placeholder")} />
          <FormInput required type="number" name="capacity" label={t("capacity.name")} placeholder={t("capacity.placeholder")} />
        </div>
      </div>
